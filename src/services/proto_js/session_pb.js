...
sec2: (f = msg.getSec2()) && sec2_pb.Sec2Payload.toObject(includeInstance, f)
  };
...
proto.SessionData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 11:
      ...
      break;
    case 12:
      var value = new sec2_pb.Sec2Payload;
      reader.readMessage(value,sec2_pb.Sec2Payload.deserializeBinaryFromReader);
      msg.setSec2(value);
      break;
    default:
      reader.skipField();
...
proto.SessionData.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      12,
      f,
      sec2_pb.Sec2Payload.serializeBinaryToWriter
    );
  }
};
...
proto.SessionData.prototype.getSec2 = function() {
  return /** @type{?proto.Sec2Payload} */ (
    jspb.Message.getWrapperField(this, sec2_pb.Sec2Payload, 12));
};
