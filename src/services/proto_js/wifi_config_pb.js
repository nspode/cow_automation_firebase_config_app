 ...
 * @const
 */
proto.RespGetStatus.oneofGroups_ = [[10,11,12]];
...
failReason: (f = jspb.Message.getField(msg, 10)) == null ? undefined : f,
connected: (f = msg.getConnected()) && wifi_constants_pb.WifiConnectedState.toObject(includeInstance, f),
attemptFailed: (f = msg.getAttemptFailed()) && wifi_constants_pb.WifiAttemptFailed.toObject(includeInstance, f)
  };
...
proto.RespGetStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 11:
      ...
      break;
    case 12:
      var value = new wifi_constants_pb.WifiAttemptFailed;
      reader.readMessage(value,wifi_constants_pb.WifiAttemptFailed.deserializeBinaryFromReader);
      msg.setAttemptFailed(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.RespGetStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getAttemptFailed();
  if (f != null) {
    writer.writeMessage(
      12,
      f,
      wifi_constants_pb.WifiAttemptFailed.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional WifiAttemptFailed attempt_failed = 12;
 * @return {?proto.WifiAttemptFailed}
 */
proto.RespGetStatus.prototype.getAttemptFailed = function() {
  return /** @type{?proto.WifiAttemptFailed} */ (
    jspb.Message.getWrapperField(this, wifi_constants_pb.WifiAttemptFailed, 12));
};


/**
 * @param {?proto.WifiAttemptFailed|undefined} value
 * @return {!proto.RespGetStatus} returns this
*/
proto.RespGetStatus.prototype.setAttemptFailed = function(value) {
  return jspb.Message.setOneofWrapperField(this, 12, proto.RespGetStatus.oneofGroups_[0], value);
};
 ...
 * @return {!proto.RespGetStatus} returns this
 */
proto.RespGetStatus.prototype.clearAttemptFailed = function() {
  return this.setAttemptFailed(undefined);
};
 ...
 * @return {boolean}
 */
proto.RespGetStatus.prototype.hasAttemptFailed = function() {
